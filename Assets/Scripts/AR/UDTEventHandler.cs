...
public class UDTEventHandler : MonoBehaviour, IUserDefinedTargetEventHandler
{
    ...
    private GameObject mQualityDialog,mQualityStatus;
    ...
    public void Start()
    {
        ...
        Prototype.NetworkLobby.LobbyManager.s_Singleton.targetBuilder = BuildNewTarget;
        Transform UDTPanel = Prototype.NetworkLobby.LobbyManager.s_Singleton.m_ReadyPanel.GetChild(2).GetChild(1);
        mQualityStatus = UDTPanel.GetChild(0).gameObject;
        mQualityDialog = UDTPanel.GetChild(1).gameObject;
        if (mQualityDialog)
        {
    ...
    public void OnInitialized()
    {
        ...
        if (mObjectTracker != null)
        {
            ...
            mObjectTracker.GetActiveDataSets();
            //mObjectTracker.DeactivateDataSet(mObjectTracker.GetActiveDataSets());
    ...
    public void OnFrameQualityChanged(ImageTargetBuilder.FrameQuality frameQuality)
    {
        ...
        if (mFrameQuality == ImageTargetBuilder.FrameQuality.FRAME_QUALITY_LOW|| mFrameQuality == ImageTargetBuilder.FrameQuality.FRAME_QUALITY_MEDIUM)
        {
            mQualityStatus.GetComponent<Text>().text = "Bad";
        }
        else
        {
            mQualityStatus.GetComponent<Text>().text = "Good";
        }
    }
    ...
    public void OnNewTrackableSource(TrackableSource trackableSource)
    {
        ...
        imageTargetCopy.transform.SetParent(ImageTargetTemplate.transform.parent);
        imageTargetCopy.transform.localPosition = Vector3.zero;
        imageTargetCopy.transform.localScale = ImageTargetTemplate.transform.localScale;
        ...
        //disable and renable for image detect purpose
        //ImageTargetTemplate.GetComponent<ImageTargetBehaviour>().enabled = false;
        //ImageTargetTemplate.GetComponent<ImageTargetBehaviour>().enabled = true;
    }
    ...
    private void StopExtendedTracking()
    {
        ...
        bool extTrackingEnabled = true;//mTrackableSettings && mTrackableSettings.IsExtendedTrackingEnabled();
