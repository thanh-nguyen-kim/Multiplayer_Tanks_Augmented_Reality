...
public class TankHealthOffline : MonoBehaviour
{
    ...
    private TankShootingOffline m_TankShooting;
    [HideInInspector]
    public TankManagerOffline m_Manager;                   //Associated manager, to disable control when dying.
    ...
    private void Awake()
    {
        m_TankShooting = GetComponent<TankShootingOffline>();
    ...
    public void Damage(float amount)
    {
        ...
        if (m_TankAI != null) m_TankAI.state = AIState.Attack;
    ...
    private void SetTankActive(bool active)
    {
        ...
        if (m_TankShooting) m_TankShooting.EnableComponent(active);
        if (m_TankAI != null) m_TankAI.EnableComponent(active);
    }
