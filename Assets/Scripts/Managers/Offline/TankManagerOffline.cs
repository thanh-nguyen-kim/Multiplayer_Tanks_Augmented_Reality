...
[Serializable]
public class TankManagerOffline
{
    ...
    public int tankType;
    public TankMovementOffline m_Movement;        // References to various objects for control during the different game phases.
    public TankShootingOffline m_Shooting;
    public TankHealthOffline m_Health;
    public TankSetupOffline m_Setup;


    public void Setup()
    {
        // Get references to the components.
        m_Movement = instance.GetComponent<TankMovementOffline>();
        m_Shooting = instance.GetComponent<TankShootingOffline>();
        m_Health = instance.GetComponent<TankHealthOffline>();
        m_Setup = instance.GetComponent<TankSetupOffline>();
